...
const TimerButton:React.FC<TimerButtonProp> = ({onClick, timeLimit, selectedColor}) => {
    ...
    return (
        <button
            ...
            className={`font-sans fixed flex justify-center items-center bottom-[5%] left-1/2 -translate-x-1/2 px-4 py-2 min-w-[160px] w-[10%] h-[8%] text-2xl font-bold max-w-full rounded-lg ${isDisabled ? "bg-gray-400 cursor-not-allowed" : ""}`}
            style={{
